...
<title>Get Car : Your every trip needs a trusted Companion.</title>
<!--Bootstrap -->
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>At our ever growing list of Cars of all kinds , find the one that best suits you and your purpose.</p>
    </div>
    <div class="row"> 
  ...
  <div class="container div_zindex">
    <div class="row">
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m" style="background:#8300bb;">
          <div class="cell">
            <h2><i class="fa fa-trophy" aria-hidden="true"></i>#1</h2>
            <p>Budding Website</p>
          </div>
        </div>
      </div>
