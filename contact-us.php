        ...
        <div class="contact_detail">
          <ul>
            <li>
              ...
              <div class="contact_info_m">Kamrej , Surat , Gujarat.</div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:61-1234-567-90">6399863578</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:nishchaysingh13579@gmail.com">nishchaysingh13579@gmail.com</a></div>
            </li>
          </ul>
        </div>
      </div>
